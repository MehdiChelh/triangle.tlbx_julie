...
#setwd('\\\\fr0002sr09/Actuariat/3-R&D/1 Assurance/11 - Projet P&C/2019 - Shiny-CL/shiny-server-master/claimsreserving/ui')  # -- Mehdi -- 
# source("Preamble.R", local=TRUE)$value  # -- Mehdi --
header <- dashboardHeader(disable=TRUE)

# --- Mehdi ---
# ajout depuis Preamble.R
appCSS <- "
#loading-content {
position: absolute;
background: #000000;
